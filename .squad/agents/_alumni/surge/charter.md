...
- Does not own growth logic (that's Erika) — provides data Erika consumes
- Does not own visuals (that's Sabrina) — provides parameters Sabrina renders
