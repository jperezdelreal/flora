...
export const UNLOCK_MILESTONES: Record<MilestoneType, MilestoneConfig[]> = {
  plants_harvested: [
    ...
    },
    {
      ...
      description: 'Harvest 15 plants — improved watering can',
      threshold: 15,
      rewardType: 'tool',
      rewardValue: ToolType.WATER,
      icon: '💧',
    ...
    {
      id: 'harvest_25',
      displayName: 'Soil Scientist',
      description: 'Harvest 25 plants to unlock the Soil Tester',
      threshold: 25,
      rewardType: 'tool',
      rewardValue: ToolType.SOIL_TESTER,
      icon: '🔬',
    },
    {
      id: 'harvest_30',
    ...
    {
      id: 'harvest_40',
      displayName: 'Irrigation Expert',
      description: 'Harvest 40 plants — advanced watering can',
      threshold: 40,
      rewardType: 'tool',
      rewardValue: ToolType.WATER,
      icon: '💧',
  ...
  runs_completed: [
    ...
    {
      id: 'runs_10',
      displayName: 'Pest Control Expert',
      description: 'Complete 10 runs to unlock Pest Spray',
      threshold: 10,
      rewardType: 'tool',
      rewardValue: ToolType.PEST_SPRAY,
      icon: '🧴',
    },
    {
      id: 'runs_15',
      displayName: 'Master Builder',
      description: 'Complete 15 runs to unlock the Trellis',
      threshold: 15,
      rewardType: 'tool',
      rewardValue: ToolType.TRELLIS,
      icon: '🪜',
    },
    {
      id: 'runs_20',
